...
VALUES
  ...
  ('The Feeler', 'With this learning pack, your baby will be developing their senses: sight, touch, and hearing. Listen and play with sensory based songs, to help your child develop and learn.', 3, 4, 'https://res.cloudinary.com/dke4ukd0z/image/upload/v1714072908/Songbee/babyTwo_wwwfns.jpg', 'Can You Say Mama?', 'Let’s Smile!', 'Buckle Up!', 'Roll Over', 'Are Those My Eyes?', 'The Wheels On The Bus', 'Is That You?'),
  ('The Detector', 'With this learning pack, help your baby develop fine motor skills and dive into the world of tactile fun.', 5, 6, 'https://res.cloudinary.com/dke4ukd0z/image/upload/v1714072568/Songbee/babyThree_vboal1.jpg', 'What Do You See?', 'Shake it Up and Down', 'Let’s Start to Eat', 'Stand Up, Sit Up, Follow Along', 'I Always Come Back', 'The Color Song', 'It’s Time to go to the Doctor'),
