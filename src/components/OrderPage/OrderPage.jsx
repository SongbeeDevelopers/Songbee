  ...
  return (
    <div className="orderPageContainer">
      ...
      <form className='orderForm'>
        <select className='orderInput' name="delivery">
          <option selected disabled value={null}>Select Delivery Option</option>
        ...
        <select className='orderInput' name="streaming">
          <option selected disabled value={null}>Select Streaming Option</option>
          <option value={true}>Add Streaming</option>
          <option value={false}>No Streaming</option>
        </select>
        <select className='orderInput' name="verses">
          <option selected disabled value={null}>Select Number of Verses</option>
