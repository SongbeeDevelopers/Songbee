  ...
  const questions = [
    {
      ...
      answer:
        "For 0-12 months learning packs are $80/pack and deliver every two months. Starting at 1 year, packs are $120/pack and deliver every three months.",
    },
    {
      id: 0,
    ...
    },
    {
      ...
      answer:
        "Delivery is immediately available on your customer portal. You can view your learning songs and play guides on the portal. If your selected pack does have physical items, typical U.S. ground shipping delivery takes 5-7 business days.",
    },
    {
      id: 0,
      question: "Can I cancel my subscription?",
      answer: "Yes you can skip a month or cancel your subscription anytime.",
    },
    {
      id: 0,
      question: "How do I contact Songbee for support?     ",
      answer:
        "You can message us on your customer portal anytime or send us an email for support at hello@songbee.com. We will respond to your support request as soon as possible. We are here to help you and your child on this important journey!     ",
    },
  ];
  return (
