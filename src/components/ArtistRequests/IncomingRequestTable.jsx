...
function IncomingRequestTable({ num }) {
  // hooks
  ...
  useEffect(() => {
    if (juniorRequests) {
      setIncomingRequests(juniorRequests.filter((song) => !song.accepted));
    }
  }, [juniorRequests]);
  // modal state
        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="center">Accept Request</StyledTableCell>
            </TableRow>
          </TableHead>
